...
export default defineComponent({
  setup() {
    ...
    const usernameErrors = computed(() => validator.value.username.$errors.map(e => e.$message));
    const passwordErrors = computed(() => validator.value.password.$errors.map(e => e.$message));
    ...
    return {
      form, passwordVisible, togglePassword, validator, loginForm, usernameErrors, passwordErrors
    };
  },
});
</script>
